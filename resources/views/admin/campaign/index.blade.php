...
@section('content')
	<main class="content">
        <div class="container-fluid p-0">
            <h1 class="h3 mb-3"><strong>Campaign</strong> <a href="{{route('admin.campaign.new')}}" class="btn btn-outline-success"><i class="fa-solid fa-plus"></i> Add Campaign</a></h1>
                            ...
                            <table class="table table-hover my-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{route('admin.campaign.adminviews', $item->camp_number)}}"><i style="color: #000000;" class="fa-solid fa-eye"></i></a></td>
                                        <td>
