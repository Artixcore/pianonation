...
@section('content')
	...
	<main class="content">
        <div class="container-fluid p-0">
            <h1 class="h3 mb-3"><strong>{{$item->name}}</strong>  <a href="{{route('product.single.edit', $item->product_id)}}" class="btn btn-outline-success">Edit</a>   <a href="{{route('product.editimage', $item->product_id)}}" class="btn btn-outline-success">Edit Image</a></h1>
            <div class="row">
