        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">
                    <form method="post" action="{{ route('shop.image', $show->id)}}" enctype="multipart/form-data">
                        @csrf
                    <input type="file" name="shop_logo" class="form-control">
                ...
                <div class="card-body">
                    <img src="{{asset('public/shop/image')}}/{{$show->shop_logo}}" style="width:100%; height:100%;" alt="" srcset="">
                </div>
            </div>
        </div>
