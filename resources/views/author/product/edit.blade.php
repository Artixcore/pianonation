                            ...
                            <div class="col-sm-6">
                                <div class="card">
                                    <div class="card-body">
                                            ...
                                            <select name="category" class="form-control">
                                                ...
                                                @foreach (App\Category::all() as $imm)
                                                    <option value="{{ $imm->category }}">{{ $imm->category }}</option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <br>
                                        <img src="{{asset('product/image')}}/{{$item->photo}}" style="height: 100%; width:100%;">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                            ...
                                            <select name="sub_category" class="form-control">
                                                ...
                                                @foreach (App\SubCate::all() as $im)
                                                    <option value="{{ $im->subcategory }}">{{ $im->subcategory }}</option>
                                                @endforeach
