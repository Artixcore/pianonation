    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">We can purchase your piano!</h1>
          <h2 data-aos="fade-up" data-aos-delay="400">Here at PianoNation we also consider specific pianos to purchase. This will give us the ability to rebuild or refinish a piano that has potential for our future customers!</h2>
