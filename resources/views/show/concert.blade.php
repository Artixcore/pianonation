    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Concert Piano Rental!</h1>
          <h2 data-aos="fade-up" data-aos-delay="400"> PianoNation we offer even renting our concert pianos for events, recitals, weddings, and more. Please fill out the form so we can review details of your need availability.” Get your free quote!</h2>

        </div>

        <div class="col-lg-8 order-1 order-lg-2 hero-img" data-aos="fade-left" data-aos-delay="200">
          <img src="{{asset('img/030.jpg')}}" class="img-fluid animated" alt="">
              ...
              <div class="row">
                ...
                <div class="col-lg-12 col-md-12" style="text-align: center;" data-aos="fade-up" data-aos-delay="300">
                  ...
                  <form action="{{route('public-form-nonimg')}}" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-4 form-group mt-3">
                            <input type="text" class="form-control" name="day_time_drop_off"  placeholder="Day and Time of Drop-Off">
                          </div>

                          <div class="col-md-4 form-group mt-3">
                            <input type="text" class="form-control" name="day_time_drop_off_2"  placeholder="Day and Time of Drop-Off">
                          </div>

                          <div class="col-md-4 form-group mt-3">
                            <input type="text" class="form-control" name="stairs"  placeholder="Is there Any Stairs?? if yes How many?">
                          </div>
                    </div>
                    ...
                    <div class="row">
                          ...
                          <div class="col-md-3 form-group mt-3">
                            <label for=""><b>Location (Inside or Outside)</b></label><br/>
                            <input type="checkbox" name="location" value="Inside"> Inside &nbsp;&nbsp;&nbsp;&nbsp;  <input type="checkbox" name="location" value="Outside"> Outside
                          </div>

                          <div class="col-md-3 form-group mt-3">
                            <label for=""><b>Concert Piano Size</b></label><br/>
                            <input type="checkbox" name="piano_size" > 7 ft. &nbsp;&nbsp;&nbsp;&nbsp;  <input type="checkbox" name="" > 9 ft.

                          </div>

                          <div class="col-md-6 form-group mt-3">
                              <label for="">What Type of Event?</label>
                            <input type="text" class="form-control" name="event_piano"  placeholder="What Tye of Event">
                          </div>
                      </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 form-group mt-3">
                        <input type="text" class="form-control" name="zip"  placeholder="Full Address">
                    </div>
                    </div>
