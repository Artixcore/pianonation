    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Consign My Piano!</h1>
          <h2 data-aos="fade-up" data-aos-delay="400"> Looking for a professional showroom to help sell your piano? These are one of many services we can provide. Let us take the walk in traffic instead of them coming into your home!</h2>

        </div>

        <div class="col-lg-8 order-1 order-lg-2 hero-img" data-aos="fade-left" data-aos-delay="200">
          <img src="{{asset('img/111.jpeg')}}" class="img-fluid animated" alt="">
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-lg-12 col-md-12" style="text-align: center;" data-aos="fade-up" data-aos-delay="300">
                <label><h1>Sell Your Piano</h1></label>
                <p></p>
              <form action="{{ route('public-form')}}" method="post" enctype="multipart/form-data">
                  @csrf
                <div class="row">
                  <div class="col-md-4 form-group mt-3 mt-md-0">
                    <input type="text" name="f_name" class="form-control" id="name" placeholder="First Name" required>
                  </div>
                  <input type="hidden" name="lead_name" value="Move My Piano">
                  <div class="col-md-4 form-group mt-3 mt-md-0">
                ...
                <div class="row py-3">
                    ...
                    <div class="col-md-6 form-group mt-3 mt-md-0">
                      <input type="file" name="pic_1" class="form-control" required>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-5 form-group mt-3">
                      ...
                      <div class="col-md-7 form-group mt-3">
                        ...
                        <input type="text" class="form-control" name="model_number" id="" placeholder="Model Number">
                      </div>
                  </div>
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-6 form-group mt-3">
                        <label for="">Last seen by a Tuner</label>
                        <input type="date" class="form-control" name="l_s_b_t" id="subject" placeholder="Last seen by a Tuner">
                      </div>

                      <div class="col-md-6 form-group mt-3">
                        <label for="">Price you want for the Piano</label>
                        <input type="number" class="form-control" name="ask_price" id="subject" placeholder="Price you want for the Piano">
                      </div>
                  </div>
              ...
              <div class="row">
                ...
                <div class="col-md-8 form-group mt-3">
                  ...
                  <input type="text" class="form-control" name="location" id="subject" placeholder="Location of Piano">
                </div>
                  ...
                  <input type="checkbox" name="piano_type" value="Player Piano"><label for="vehicle1">&nbsp; Player Piano</label>&nbsp;&nbsp;&nbsp;
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="col-md-6">
                              <input type="text" name="special_piano" class="form-control" placeholder="Your Favorite Piano">
                          </div>
                      </div>
                  </div> --}}
