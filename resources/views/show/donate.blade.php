    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Donate Your Piano!</h1>
        ...
        <div class="col-lg-8 order-1 order-lg-2 hero-img" data-aos="fade-left" data-aos-delay="200">
          <img src="{{asset('img/444.jpg')}}" class="img-fluid animated" alt="">
            ...
            <div class="container">
              ...
              <div class="row">
                ...
                <div class="col-lg-12 col-md-12" style="text-align: center;" data-aos="fade-up" data-aos-delay="300">
                    <label><h1>Fill your Piano Details</h1></label>
                  ...
                  <form action="{{route('public-form')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row py-3">
                        ...
                        <div class="col-md-6 form-group mt-3 mt-md-0">
                            ...
                            <input type="text" class="form-control" name="manufacturer" id="" placeholder="Brand/Manufacturer">
                        </div>
{{--

                        <div class="col-md-3 form-group mt-3 mt-md-0">
                          <input type="file" name="pic_2" class="form-control" required>
                        </div>

                        <div class="col-md-3 form-group mt-3 mt-md-0">
                          <input type="file" class="form-control" name="pic_3" required>
                        </div>

                        <div class="col-md-3 form-group mt-3 mt-md-0">
                          <input type="file" class="form-control" name="pic_4" required>
                        </div> --}}
