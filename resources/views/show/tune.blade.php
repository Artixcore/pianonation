    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Tune Your Piano</h1>
          <h2 data-aos="fade-up" data-aos-delay="400"> PianoNation can recommend professional technicians that can tune and service your piano. Having this peace of mind of knowing your piano will be in good hands is important and “instrumental” to build trust and care for our clients!</h2>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-lg-12 col-md-12" style="text-align: center;" data-aos="fade-up" data-aos-delay="300">
                <label><h1>Tune Your Piano</h1></label>
                <p></p>
                ...
                <div class="form-group mt-3">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="price_range" placeholder="Serial Number" class="form-control">
                        </div>
                        <div class="col-md-4">
                             <label for="">Model Number:</label>
                            <input type="text" name="price_range" placeholder="Model Number" class="form-control">
                        </div>
                        <div class="col-md-4">
                           <label for="">Last Tune By Tuner:</label>
                            <input type="date" name="price_range" placeholder="Last Seen by Tuner" class="form-control date">
                        </div>
                      </div>
                  </div>
              ...
              <div class="row">
                ...
                <div class="col-md-3 form-group mt-3">
                    <input type="text" class="form-control" name="address" id="subject" placeholder="Brand or Manufacturer">
                </div>
                ...
                {{-- <div class="col-md-3 form-group mt-3">
                    <input type="text" class="form-control" name="address" id="subject" placeholder="New Location of the Piano to be Moved">
                </div> --}}
