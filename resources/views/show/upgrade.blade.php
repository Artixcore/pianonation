    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Upgrade your current Piano!</h1>
          <h2 data-aos="fade-up" data-aos-delay="400"> Here at PianoNation we are more than experience to take your current piano with its player system and UPGRADE it with the NEWEST Technology!</h2>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-lg-12 col-md-12" style="text-align: center;" data-aos="fade-up" data-aos-delay="300">
                <label><h1>Upgrade My Piano</h1></label>
                <p></p>
              ...
              {{-- <form action="{{route('mail')}}" method="post"> --}}
                ...
                <div class="form-group mt-3">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label for="">Picture of Current Player System:</label>
                            <input type="file" name="price_range" class="form-control">
                        </div>

                        <div class="col-md-6">
                            <label for="">Picture of piano:</label>
                            <input type="file" name="price_range" class="form-control">
                        </div>
